...
const
  ...
  issues = [ # tests that are currently expected to fail
    "t01_literal_false.test",
    "t01_literal_true.test",
    ...
    "t02_tuple_constructor_3.test",
    "t02_unit_constructor.test",
    "t03_tuple_access_1.test",
    "t03_tuple_access_2.test",
    "t03_tuple_access_3.test",
    "t03_unit_in_tuple.test",
    ...
    "t08_if_expr_both_void.test",
    "t08_if_expr_else_void.test",
    "t08_if_expr_then_void.test",
    "t08_if_expr_unify_type_1.test",
    "t08_if_expr_unify_type_2.test",
    "t08_if_false.test",
    "t08_if_only_body_unit.test",
    "t08_if_only_body_void.test",
    "t08_if_true.test",
    ...
    "t09_exprs_eval_order_1.test",
    "t09_exprs_eval_order_2.test",
    "t09_exprs_single_2.test",
    "t10_asgn_eval_order_1.test",
    "t10_asgn_eval_order_2.test",
    "t10_asgn_eval_order_3.test",
    "t10_asgn_lhs_must_be_lvalue_1.test",
    "t10_asgn_lhs_must_be_lvalue_2.test",
    "t10_asgn_lhs_must_be_lvalue_3.test",
    "t10_asgn_lhs_must_be_lvalue_8.test",
    "t11_scopes_if_1.test",
    "t11_scopes_local_cannot_shadow_error_1.test",
    "t11_scopes_procdef.test",
    "t12_and_result_1.test",
    "t12_and_result_2.test",
    "t12_and_result_3.test",
    "t12_and_result_4.test",
    "t12_and_scoping_1.test",
    "t12_and_short_circuit.test",
    "t12_or_result_1.test",
    "t12_or_result_2.test",
    "t12_or_result_3.test",
    "t12_or_result_4.test",
    ...
    "t15_while_unit_body.test",
    "t15_while_void_body.test",
    "t16_seq_construct_empty.test",
    "t16_seq_construct_non_empty.test",
    "t16_seq_construct_with_subtype.test",
    "t16_seq_construct_with_unit.test",
    "t16_seq_construct_with_void_error.test",
    "t16_seq_type_with_void_error.test",
    "t17_seq_at.test",
    "t17_seq_at_eval_order_1.test",
    "t17_seq_at_eval_order_2.test",
    ...
    "t17_seq_copy_3.test",
    "t17_seq_copy_4.test",
    "t17_seq_len_empty.test",
    "t17_seq_len_non_empty.test",
